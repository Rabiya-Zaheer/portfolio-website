...
// Validate ../../src/app/api/verify-recaptcha/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/verify-recaptcha">> = Specific
  const handler = {} as typeof import("../../src/app/api/verify-recaptcha/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
